...
## Project Structure
    ...
    ├── app_creation_fail_t_93629  # Django project configurations
...
1. Clone this repo and `cd app_creation_fail_t_93629`
...
2. Clone this repo and `cd app_creation_fail_t_93629`
